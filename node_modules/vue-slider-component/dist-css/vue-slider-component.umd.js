...
function vue_slider_dot_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
var vue_slider_dot_VueSliderDot = /*#__PURE__*/function (_Vue) {
...
__decorate([Prop({
  default: 0
})], vue_slider_dot_VueSliderDot.prototype, "value", void 0);
...
__decorate([Prop({
  ...
  required: true
})], vue_slider_dot_VueSliderDot.prototype, "tooltipPlacement", void 0);

__decorate([Prop({
  type: [String, Function]
})], vue_slider_dot_VueSliderDot.prototype, "tooltipFormatter", void 0);

__decorate([Prop({
  type: Boolean,
  default: false
})], vue_slider_dot_VueSliderDot.prototype, "focus", void 0);

__decorate([Prop({
  default: false
})], vue_slider_dot_VueSliderDot.prototype, "disabled", void 0);

__decorate([Prop(Object)], vue_slider_dot_VueSliderDot.prototype, "dotSlot", void 0);

__decorate([Prop(Object)], vue_slider_dot_VueSliderDot.prototype, "tooltipSlot", void 0);

vue_slider_dot_VueSliderDot = __decorate([Options({
  name: 'VueSliderDot',
  emits: ['DragStart']
...
function vue_slider_mark_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
var vue_slider_mark_VueSlideMark = /*#__PURE__*/function (_Vue) {
...
__decorate([Prop({
  required: true
})], vue_slider_mark_VueSlideMark.prototype, "mark", void 0);
...
__decorate([Prop(Object)], vue_slider_mark_VueSlideMark.prototype, "stepSlot", void 0);

__decorate([Prop(Object)], vue_slider_mark_VueSlideMark.prototype, "labelSlot", void 0);

vue_slider_mark_VueSlideMark = __decorate([Options({
  name: 'VueSliderMark',
  emits: ['PressLabel']
...
function control_iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
...
function vue_slider_iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
...
function vue_slider_iterableToArrayLimit(arr, i) { var _i = arr && (typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"]); if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }
...
function vue_slider_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
  ...
  vue_slider_createClass(VueSlider, [{
    ...
    get: function get() {
      var _ref = Array.isArray(this.dotSize) ? this.dotSize : [this.dotSize, this.dotSize],
          _ref2 = vue_slider_slicedToArray(_ref, 2),
          dotWidth = _ref2[0],
          dotHeight = _ref2[1];
    ...
    get: function get() {
      ...
      return this.control.processArray.map(function (_ref3, index) {
        ...
        var _ref4 = vue_slider_slicedToArray(_ref3, 3),
            start = _ref4[0],
            end = _ref4[1],
            style = _ref4[2];
        ...
        var sizeStyleKey = _this2.isHorizontal ? 'width' : 'height';
        return {
          start: start,
          end: end,
          index: index,
          style: vue_slider_objectSpread(vue_slider_objectSpread((_objectSpread2 = {}, vue_slider_defineProperty(_objectSpread2, _this2.isHorizontal ? 'height' : 'width', '100%'), vue_slider_defineProperty(_objectSpread2, _this2.isHorizontal ? 'top' : 'left', 0), vue_slider_defineProperty(_objectSpread2, _this2.mainDirection, "".concat(start, "%")), vue_slider_defineProperty(_objectSpread2, sizeStyleKey, "".concat(end - start, "%")), vue_slider_defineProperty(_objectSpread2, "transitionProperty", "".concat(sizeStyleKey, ",").concat(_this2.mainDirection)), vue_slider_defineProperty(_objectSpread2, "transitionDuration", "".concat(_this2.animateTime, "s")), _objectSpread2), _this2.processStyle), style)
        };
      });
    }
  }, {
    ...
    get: function get() {
      var _ref6 = Array.isArray(this.dotSize) ? this.dotSize : [this.dotSize, this.dotSize],
          _ref7 = vue_slider_slicedToArray(_ref6, 2),
          dotWidth = _ref7[0],
          dotHeight = _ref7[1];
    ...
    get: function get() {
      ...
      return this.control.dotsPos.map(function (pos, index) {
        return vue_slider_objectSpread({
          pos: pos,
          index: index,
          value: _this3.control.dotsValue[index],
          focus: _this3.states.has(SliderState.Focus) && _this3.focusDotIndex === index,
          disabled: _this3.disabled,
          style: _this3.dotStyle
        }, (Array.isArray(_this3.dotOptions) ? _this3.dotOptions[index] : _this3.dotOptions) || {});
      });
    }
  }, {
    key: "animateTime",
    ...
    get: function get() {
      ...
      if (this.marks) {
        ...
        return function (val) {
          ...
          _this5.vData.some(function (obj) {
            if (obj[_this5.dataValue] === val) {
              mark.label = obj[_this5.dataLabel];
              return true;
            }
    ...
    get: function get() {
      ...
      if (this.tooltipFormatter) {
        ...
        return function (val) {
          ...
          _this6.vData.some(function (obj) {
            if (obj[_this6.dataValue] === val) {
              tooltipText = obj[_this6.dataLabel];
              return true;
            }
    ...
    value: function initControl() {
      ...
      ['vData', 'enableCross', 'fixed', 'max', 'min', 'interval', 'minRange', 'maxRange', 'order', 'marks', 'process', 'adsorb', 'included', 'dotOptions'].forEach(function (name) {
        _this7.$watch(name, function (val) {
          if (name === 'vData' && Array.isArray(_this7.control.data) && Array.isArray(val) && _this7.control.data.length === val.length && val.every(function (item, index) {
            return item === _this7.control.data[index];
          })) {
            return false;
          }
          ...
          switch (name) {
            ...
            case 'dataLabel':
            case 'dataValue':
              _this7.control.data = _this7.sliderData;
              break;

            case 'mark':
              _this7.control.marks = _this7.sliderMarks;
              break;

            default:
              ;
              _this7.control[name] = val;
          }
    ...
    value: function dragEnd(e) {
      ...
      setTimeout(function () {
        if (_this8.lazy) {
          _this8.syncValueByPos();
        }

        if (_this8.included && _this8.isNotSync) {
          _this8.control.setValue(_this8.modelValue);
        } else {
          // Sync slider position
          _this8.control.syncDotsPos();
        }

        _this8.states.delete(SliderState.Drag); // If useKeyboard is true, keep focus status after dragging


        if (!_this8.useKeyboard || 'targetTouches' in e) {
          _this8.states.delete(SliderState.Focus);
        }

        _this8.$emit('drag-end', _this8.focusDotIndex);
      });
    }
  }, {
    key: "blurHandle",
    ...
    value: function setIndex(index) {
      ...
      var value = Array.isArray(index) ? index.map(function (n) {
        return _this9.control.getValueByIndex(n);
    ...
    value: function setValueByPos(pos) {
      ...
      setTimeout(function () {
        if (_this10.included && _this10.isNotSync) {
          _this10.control.setValue(_this10.modelValue);
        } else {
          _this10.control.syncDotsPos();
        }
      });
    }
  }, {
      ...
      if (handleFunc) {
        ...
        if (isInclude) {
          this.control.markList.some(function (mark, index) {
            if (mark.value === _this11.control.dotsValue[_this11.focusDotIndex]) {
    ...
    value: function render() {
      ...
      return Object(external_commonjs_vue_commonjs2_vue_root_Vue_amd_vue_["createVNode"])("div", Object(external_commonjs_vue_commonjs2_vue_root_Vue_amd_vue_["mergeProps"])({
        ...
        return _this12.renderSlot('process', item, Object(external_commonjs_vue_commonjs2_vue_root_Vue_amd_vue_["createVNode"])("div", {
        ...
        var stepSlot = _this12.renderSlot('step', mark, null);

        var labelSlot = _this12.renderSlot('label', mark, null);

        return _this12.renderSlot('mark', mark, Object(external_commonjs_vue_commonjs2_vue_root_Vue_amd_vue_["createVNode"])(Object(external_commonjs_vue_commonjs2_vue_root_Vue_amd_vue_["resolveComponent"])("vue-slider-mark"), {
          "key": "mark-".concat(index),
          "mark": mark,
          "hideLabel": _this12.hideLabel,
          "style": (_ref8 = {}, vue_slider_defineProperty(_ref8, _this12.isHorizontal ? 'height' : 'width', '100%'), vue_slider_defineProperty(_ref8, _this12.isHorizontal ? 'width' : 'height', _this12.tailSize), vue_slider_defineProperty(_ref8, _this12.mainDirection, "".concat(mark.pos, "%")), _ref8),
          "stepStyle": _this12.stepStyle,
          "stepActiveStyle": _this12.stepActiveStyle,
          "labelStyle": _this12.labelStyle,
          "labelActiveStyle": _this12.labelActiveStyle,
          "onPressLabel": function onPressLabel(pos) {
            return _this12.clickable && _this12.setValueByPos(pos);
          },
          "stepSlot": stepSlot,
          "labelSlot": labelSlot
        }, null));
        ...
        var dotSlot = _this12.renderSlot('dot', dot, null);

        var tooltipSlot = _this12.renderSlot('tooltip', dot, null);
        ...
        return Object(external_commonjs_vue_commonjs2_vue_root_Vue_amd_vue_["createVNode"])(Object(external_commonjs_vue_commonjs2_vue_root_Vue_amd_vue_["resolveComponent"])("vue-slider-dot"), Object(external_commonjs_vue_commonjs2_vue_root_Vue_amd_vue_["mergeProps"])({
          ...
          "tooltip": dot.tooltip || _this12.tooltip,
          "tooltip-style": [_this12.tooltipStyle, dot.tooltipStyle, dot.disabled ? dot.tooltipDisabledStyle : null, dot.focus ? dot.tooltipFocusStyle : null],
          "tooltip-formatter": Array.isArray(_this12.sliderTooltipFormatter) ? _this12.sliderTooltipFormatter[index] : _this12.sliderTooltipFormatter,
          "tooltip-placement": _this12.tooltipDirections[index],
          "style": [_this12.dotBaseStyle, (_ref9 = {}, vue_slider_defineProperty(_ref9, _this12.mainDirection, "".concat(dot.pos, "%")), vue_slider_defineProperty(_ref9, "transition", "".concat(_this12.mainDirection, " ").concat(_this12.animateTime, "s")), _ref9)],
          "onDragStart": function onDragStart() {
            return _this12.dragStart(index);
          },
          "role": "slider",
          "aria-valuenow": dot.value,
          "aria-valuemin": _this12.min,
          "aria-valuemax": _this12.max,
          "aria-orientation": _this12.isHorizontal ? 'horizontal' : 'vertical',
          "tabindex": "0",
          "nativeOnFocus": function nativeOnFocus() {
            return _this12.focus(dot, index);
          },
          "nativeOnBlur": function nativeOnBlur() {
            return _this12.blur();
          }
        }, {
          attrs: _this12.dotAttrs
        }, {
          "dotSlot": dotSlot,
...
__decorate([Prop({
  default: 0
})], vue_slider_VueSlider.prototype, "modelValue", void 0);
...
__decorate([Prop({
  type: [Array, Object]
})], vue_slider_VueSlider.prototype, "vData", void 0);
...
__decorate([Watch('modelValue')], vue_slider_VueSlider.prototype, "onValueChanged", null);

vue_slider_VueSlider = __decorate([Options({
  name: 'VueSlider',
